<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        for ($i=1; $i <= 10; $i++) { 
            if (${"A$i"} != '') {
                // echo ${"A$i"};
                $query = "INSERT INTO shoppingcart(username, seat) VALUES(\"$username\", \"".${"A$i"}."\")";
        ...
        for ($i=1; $i <= 10; $i++) { 
            if (${"B$i"} != '') {
                // echo ${"A$i"};
                $query = "INSERT INTO shoppingcart(username, seat) VALUES(\"$username\", \"".${"B$i"}."\")";
                execute_query($mysqli, $query);
            }
        }
        ...
        for ($i=1; $i <= 10; $i++) { 
            if (${"C$i"} != '') {
                // echo ${"A$i"};
                $query = "INSERT INTO shoppingcart(username, seat) VALUES(\"$username\", \"".${"C$i"}."\")";
                execute_query($mysqli, $query);
            }
        }
        ...
        for ($i=1; $i <= 10; $i++) { 
            if (${"D$i"} != '') {
                // echo ${"A$i"};
                $query = "INSERT INTO shoppingcart(username, seat) VALUES(\"$username\", \"".${"D$i"}."\")";
                execute_query($mysqli, $query);
            }
        }
